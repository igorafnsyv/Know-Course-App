package hkucs.knowcourse.models;
...
public class Course {
    ...
    public static List<Course> getCourses() {
        ...
        Future<String> res = executorService.submit(() -> NetworkUtility.readJson("http://localhost:8000/api/courses"));
        try {
            Gson gson = new Gson();
